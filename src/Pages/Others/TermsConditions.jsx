    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://goatwiki-backend-production.up.railway.app/api/getTermsAndConditions`
        )
  ...
  if (postArray === null) {
    ...
    return (
      <>
        <HelmetProvider>
          <Helmet>
            <title>Terms and Conditions - GoatWiki.com</title>
          </Helmet>
        </HelmetProvider>
        <div className="PPContainer">
          <div className="PPMainContainer">
            ...
            <div className="PPTitleContainer">
              <h1>Terms and Conditions for GoatWiki.com</h1>
              <p>Effective Date: [{new Date(postArray.UpdatedDate).toISOString().split('T')[0]}]</p>
            </div>
